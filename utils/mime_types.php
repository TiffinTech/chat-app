...
$mime_types = array(
   ...
   'com' => array('application/x-msdownload'),
   ...
   'lha' => array('application/x-lzh-compressed'),
   ...
   'lzh' => array('application/x-lzh-compressed'),
   ...
   'm3u8' => array('application/vnd.apple.mpegurl'),
   'm4a' => array('audio/mp4'),
   ...
   'scm' => array('application/vnd.lotus-screencam'),
   ...
   'php' => array('text/php', 'text/x-php', 'application/php', 'application/x-php', 'application/x-httpd-php', 'application/x-httpd-php-source')
);
?>
